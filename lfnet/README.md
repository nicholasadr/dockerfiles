...
2. Modify .env
   ...
   * dJUPYTER_PORT: Port in host machine that will be used to access the container's jupyter port.
   * dTENSORBOARD_PORT: Port in host machine that will be used to access the container's tensorboard port.
...
`docker-compose exec lfnet /bin/bash`
