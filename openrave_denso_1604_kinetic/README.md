...
**Note:** This dockerfile requires access to the `denso_common` private repository
...
2. Modify .env
     ...
     ```
     cd dockerfiles/openrave_denso_1604_kinetic/
     cat .env
     ```
...
`docker-compose exec orpyD16k /bin/bash`
